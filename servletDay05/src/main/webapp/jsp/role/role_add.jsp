...
<div id="main">
    ...
    <form action="http://localhost:8080/servletDay05/role/add.do" method="post" class="main_form">
        ...
        <div class="input_info_high">
            <div class="input_info_scroll">
                <ul>
                    <li><input type="checkbox" name="priviege" value="1"/>管理员管理</li>
                    <li><input type="checkbox" name="priviege" value="2"/>角色管理</li>
                    <li><input type="checkbox" name="priviege" value="3"/>资费管理</li>
                    <li><input type="checkbox" name="priviege" value="4"/>账务账号</li>
                    <li><input type="checkbox" name="priviege" value="5"/>业务账号</li>
                    <li><input type="checkbox" name="priviege" value="6"/>账单</li>
                    <li><input type="checkbox" name="priviege" value="7"/>报表</li>
                </ul>
            </div>
            <span class="required">*</span>
