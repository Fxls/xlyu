            ...
            <div class="diyTable">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th>
                            <%--申请人--%>
                            <input readonly class="input-sm" type="text" value="${zcHistoryDetail.applyerName}"/>
                        </th>
                        <th>
                            申请id
                        </th>
                        <th>
                            <%--申请人id--%>
                            <input readonly class="input-sm" type="text" value="${zcHistoryDetail.applyerId}"/>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input readonly value="${zcHistoryDetail.proName}" class="form-control" type="text">
                        </td>
                    </tr>
                    <tr>
                        <td><strong>采购产品数量</strong></td>
                        <td><input readonly value="${zcHistoryDetail.proNumber}" class="input-sm" type="text"></td>
                        <td><strong>产品单价</strong></td>
                        <td><input readonly value="${zcHistoryDetail.proPrice}.90" class="input-sm" type="text"></td>
                    </tr>
                    <tr>
                        <td><strong>申请时间</strong></td>
                        <td colspan="3">
                            <fmt:formatDate value="${zcHistoryDetail.applyTime}" pattern="yyyy-MM-dd HH:mm"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        <td colspan="4"><button type="button" class="btn btn-block btn-info btn-sm" onclick="history.back()">return</button></td>
                    </tr>
                    </tbody>
                </table>
            </div>
