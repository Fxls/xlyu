...
<div class="container">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-8 column">
            ...
            <button type="button" class="btn btn-block btn-warning btn-lg" onclick="location.href='${base}/approval/zcApprovalHistory'">点击查看我的审批记录</button>

            <h3 class="text-center text-info" style="margin-top: 10px">
                待审批
            </h3>
            <table class="table">
                <thead>
                ...
                <tbody>
                <c:forEach var="approvalZc" items="${shouldByMyHandle}">
                    <tr class="info">
                        <td>
                            ${approvalZc.id}
                        </td>
                        <td>
                            ${approvalZc.applyerName}
                        </td>
                        <td>
                           <fmt:formatDate value="${approvalZc.applyTime}" pattern="yyyy-MM-dd HH:mm"/>
                        </td>
                        <td>
                            <button type="button" class="btn btn-block btn-info btn-sm" onclick="location.href='${base}/approval/zcApprovalDetail?id=${approvalZc.id}'">查看详细</button>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
