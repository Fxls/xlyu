    ...
    <div class="row clearfix">
        ...
        <div class="col-md-8 column">
            ...
            <table class="table table-condensed table-striped">
                ...
                <tbody>
                <c:forEach items="${zcApprovalByNameAndType}" var="approval">
                    <tr>
                        <th>
                                ${approval.id}
                        </th>
                        ...
                        <th>
                            <button type="button" onclick="location.href='${base}/approval/zcHistoryDetail?id=${approval.id}'" class="btn btn-sm btn-info">查看详细</button>
                        </th>
                    </tr>
                </c:forEach>
                </tbody>
