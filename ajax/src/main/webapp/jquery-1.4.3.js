...
(function() {
	...
	jQuery.support = {
		...
		// (IE uses com.itek.ajax.filter instead)
...
var posProcess = function(selector, context){
	...
	// Position selectors must be done after the com.itek.ajax.filter
...
// Implement the identical functionality for com.itek.ajax.filter and not
...
if ( !jQuery.support.opacity ) {
	jQuery.cssHooks.opacity = {
		...
		set: function( elem, value ) {
			...
			// Set the alpha com.itek.ajax.filter to set the opacity
...
jQuery.extend({
	...
	httpData: function( xhr, type, s ) {
		...
		// The com.itek.ajax.filter can actually parse the response
		if ( typeof data === "string" ) {
