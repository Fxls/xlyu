...
public class String_Methods {
    ...
    /**
     * @Param
     * @description charAt(int index)(用于返回字符串中对应index的字符，返回类型为char)
    ...
    /**
     * @Param
     * @description equals(String other)(用于比较字符串类容，返回类型为boolean类型)
    ...
    /**
     * @Param
     * @description indexOf(String string)(用于检索一个字符串在另一个字符串出现的位置，返回类型为int，如果没有对应值则返回1)
    ...
    /**
     * @Param
     * @description lastIndexOf(String string)(检测字符串最后一次出现的位置，返回类型为int)
    ...
    /**
     * @Param
     * @description startWith&endWith(String prefix)(检测字符串的前缀和后缀，返回类型为boolean)
    ...
    /**
     * @Param
     * @description substring(int beginIndex,int engIndex)(返回对应范围的字符串，注意包前不包后的原则)
    ...
    public void substring() {
        ...
        System.out.println(str2);//Chou
        System.out.println(str3);//Ch
    }

    @Test
    /**
     * @Param
     * @description toLowerCase&toUpperCase(字符串大小写转化，返回类型为String)
    ...
    /**
     * @Param
     * @description valueOf(各种类型)(将其他类型转化为字符串类型，返回类型为String)
